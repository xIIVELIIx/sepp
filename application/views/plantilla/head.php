...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/bootstrap-select-1.10.0/dist/css/bootstrap-select.min.css">
    <!-- Font Awesome -->
    ...
    <!-- Date Picker -->
    <link rel="stylesheet" href="<?= base_url() ?>dashboard/plugins/datepicker/datepicker3.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="<?= base_url() ?>dashboard/plugins/daterangepicker/daterangepicker-bs3.css">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="<?= base_url() ?>dashboard/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
    <!-- Data Tabel style -->
    <link rel="stylesheet" href="<?= base_url() ?>dashboard/plugins/datatables/dataTables.bootstrap.css">
    <!-- daterange picker -->
    <link rel="stylesheet" href="<?= base_url() ?>dashboard/plugins/daterangepicker/daterangepicker-bs3.css">
    <!-- Select2 -->
