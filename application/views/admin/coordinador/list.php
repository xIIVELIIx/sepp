                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="col-md-2 text-center">
                            <a href="<?= base_url() . "admin/coordinador/add" ?>">
                                <button id="back" class="btn btn-small btn-success"><span class="glyphicon glyphicon-plus-sign">&nbsp;</span>Nuevo coordinador</button>
                            </a>
                        </div>
                    </div>
...
<script>
    ...
    $('#btn_borrar').click(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?= base_url("admin/coordinador/remove/") ?>" + id_usuario,
            dataType: 'json',
            success: function(data) {
                window.location.href = "<?= base_url("admin/coordinador") ?>";
            }
        });
    });
...
<script>
    ...
    $('#btn_enable').click(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?= base_url("admin/coordinador/enable/") ?>" + id_usuario,
            dataType: 'json',
            success: function(data) {
                window.location.href = "<?= base_url("admin/coordinador") ?>";
            }
