<?php
if($this->session->userdata("id_rol_usuario") == ID_ROL_COORDINADOR):
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                Te invitamos a acceder al menú de opciones donde podrás ver la lista de estudiantes preinscritos...
            </div>
            <!-- /.box-body -->
