        ...
        <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
                ...
                <div class="box box-success">
                    ...
                    <?= form_open("user/edit/" . @$data_user['id']) ?>

                    <!-- ////   LOAD FORM    ////////////////////--> 
                    <?php $this->load->view("common/user/partes/form_user", $data_user); ?>
...
<script>
    ...
    $("#id_facultad").change(function() {
        ...
        if (valor !== "") {
            $.ajax({
                url: "<?= base_url("user") ?>" + "/traerPrograma/" + valor,
                type: "POST",
                dataType: "json",
                success: function(msg) {
                    ...
                    for (i = 0; i < msg.length; i++) {
                        var selected = (msg[i].id == <?= $data_user["id_programa"] ?>) ? "selected=\"selected\"" : '';
