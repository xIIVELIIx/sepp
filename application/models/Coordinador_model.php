...
class Coordinador_model extends CI_Model {
    ...
    public function getAll(){
        ...
        $query = $this->db->query($sql,array(ID_ROL_COORDINADOR));
        $result = $query->result();
       
        return $result;
    }
    
    public function get($id_coordinador){
        ...
        $query = $this->db->query($sql,array(ID_ROL_COORDINADOR,$id_coordinador));
        $result = $query->result();
    ...
    public function update($data) {
        extract($data);
        $this->db->where('id', $id);
        $this->db->where('id_rol_usuario', ID_ROL_COORDINADOR);
